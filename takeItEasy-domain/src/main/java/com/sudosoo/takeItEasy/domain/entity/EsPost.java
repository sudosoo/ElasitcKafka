...
public class EsPost extends BaseEntity {
    ...
    public EsPost(Long id, String title, String content, Category category, Long memberId, String writerName, int viewCount, List<Heart> hearts) {
        this.id = id;
        this.title = title;
    ...
    public EsPost(String title, String content, String writerName) {
        this.title = title;
        this.content = content;
        this.writerName = writerName;
    }

    public EsPost(String title, String content) {
        this.title = title;
        this.content = content;
    }

    public EsPost(String title, String content, Long memberId) {
        this.title = title;
        this.content = content;
        this.memberId = memberId;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof EsPost)) return false;
        final EsPost other = (EsPost) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof EsPost;
    }
