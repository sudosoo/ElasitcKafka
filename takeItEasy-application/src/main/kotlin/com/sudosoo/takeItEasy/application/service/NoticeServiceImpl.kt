...
class NoticeServiceImpl(
    ...
    override fun subscribe(memberName: String, lastEventId: String): SseEmitter {
        ...
        val emitter: SseEmitter = emitterRepository.save(emitterCreatedTimeByMemberName, SseEmitter(com.sudosoo.takeItEasy.application.service.NoticeServiceImpl.Companion.DEFAULT_TIMEOUT))
